...
public:
    ...
    void setup(){
        ParamGroup.add(_e_chorus_in_depth.set("Depth", 0, 0, 1));
        ParamGroup.add(_e_chorus_in_depthMin.set("Depth Min", 0, 0, 1));
        ParamGroup.add(_e_chorus_in_depthMax.set("Depth Max", 1, 0, 1));
        ParamGroup.add(_e_chorus_in_depthConnectTo.set("Depth connect to", 0, 0, 6));
        
        ParamGroup.add(_e_chorus_in_speed.set("Speed", 0, 0, 1000));
        ParamGroup.add(_e_chorus_in_speedMin.set("Speed Min", 0, 0, 1000));
        ParamGroup.add(_e_chorus_in_speedMax.set("Speed Max", 1000, 0, 1000));
        ParamGroup.add(_e_chorus_in_speedConnectTo.set("Speed connect to", 0, 0, 6));
        
        ParamGroup.add(_e_chorus_in_delay.set("Delay", 0, 1, 200));
        ParamGroup.add(_e_chorus_in_delayMin.set("Delay Min", 1, 0, 200));
        ParamGroup.add(_e_chorus_in_delayMax.set("Delay Max", 200, 1, 200));
